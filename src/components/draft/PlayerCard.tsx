...
import { Star, Zap, AlertTriangle, Clock, TrendingUp } from 'lucide-react';
...
// Export as PlayerCard as well to maintain compatibility
export { DraftPlayerCard as PlayerCard };