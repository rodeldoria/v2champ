...
type CachedPlayer = Database['public']['Tables']['cached_players']['Row'];
type CachedStats = Database['public']['Tables']['cached_player_stats']['Row'];
  ...
  useEffect(() => {
    const fetchPlayer = async () => {
      try {
        ...
        // Transform cached player to Player type
